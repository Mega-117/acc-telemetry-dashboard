            ...
            <section class="tyres-card" aria-labelledby="tyres-title">
              ...
              <div class="tyres-layout">
                <div class="pressure-map">
                  ...
                  <img class="car-silhouette" src="/images/pitwall-car-top.svg?v=4" alt="Sagoma della vettura vista dall’alto">
                </div>
...
.tyres-card { padding: 15px 18px 14px; }.tyres-card h3 { margin: 0 0 10px; color: #dfe5eb; font-size: 12px; font-weight: 500; }.tyres-layout { display: grid; grid-template-columns: minmax(0,1fr) 155px; min-height: 260px; }.pressure-map { position: relative; min-width: 0; border-right: 1px solid rgba(255,255,255,.13); }.car-silhouette { position: absolute; top: 9px; left: 50%; width: 112px; height: 224px; object-fit: contain; transform: translateX(-50%); opacity: .9; user-select: none; -webkit-user-drag: none; }.tyre-control { position: absolute; z-index: 1; width: 140px; }.tyre-control--fl { top: 22px; left: 24px; }.tyre-control--fr { top: 22px; right: 24px; }.tyre-control--rl { bottom: 18px; left: 24px; }.tyre-control--rr { right: 24px; bottom: 18px; }
