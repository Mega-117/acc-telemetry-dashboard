            ...
            <section class="tyres-card" aria-labelledby="tyres-title">
              ...
              <div class="tyres-layout">
                <div class="pressure-map">
                  ...
                  <img class="car-silhouette" src="/images/pitwall-car-top.svg" alt="Sagoma della vettura vista dall’alto">
                </div>
...
.workspace { display: grid; grid-template-columns: 1.03fr .97fr; gap: 12px; align-items: stretch; }
.strategy { display: flex; min-width: 0; flex-direction: column; gap: 10px; padding: 16px 14px 12px; border: 1px solid rgba(255,255,255,.12); border-radius: 10px; background: #101820; }.panel-title { margin: 0 7px 2px; font-size: 16px; font-weight: 850; }.strategy__body { display: grid; gap: 9px; flex: 1; }.strategy-topline,.service-row,.repairs,.tyres-card { border: 1px solid rgba(255,255,255,.09); border-radius: 8px; background: rgba(255,255,255,.018); }
.strategy-topline { display: grid; grid-template-columns: 1fr 1fr; align-items: center; gap: 18px; min-height: 59px; padding: 9px 18px; }.static-control { display: flex; align-items: center; justify-content: space-between; gap: 12px; color: #d9e0e7; font-size: 12px; }.static-stepper { display: grid; grid-template-columns: 35px 78px 35px; align-items: center; overflow: hidden; border: 1px solid rgba(255,255,255,.1); border-radius: 7px; }.static-stepper button { height: 34px; border: 0; background: rgba(255,255,255,.05); color: #66717c; }.static-stepper strong { text-align: center; font-size: 12px; }
.tyres-card { padding: 15px 18px 14px; }.tyres-card h3 { margin: 0 0 10px; color: #dfe5eb; font-size: 12px; font-weight: 500; }.tyres-layout { display: grid; grid-template-columns: minmax(0,1fr) 180px; min-height: 260px; }.pressure-map { position: relative; min-width: 0; border-right: 1px solid rgba(255,255,255,.13); }.car-silhouette { position: absolute; top: 4px; left: 50%; width: 106px; height: 225px; transform: translateX(-50%); opacity: .9; }.tyre-control { position: absolute; z-index: 1; width: 152px; }.tyre-control--fl { top: 18px; left: 0; }.tyre-control--fr { top: 18px; right: 16px; }.tyre-control--rl { bottom: 12px; left: 0; }.tyre-control--rr { right: 16px; bottom: 12px; }
.tyre-settings { display: flex; flex-direction: column; justify-content: center; gap: 19px; padding-left: 26px; }.select-control { display: flex; flex-direction: column; gap: 7px; color: #dce3e9; font-size: 12px; }.select-control select { width: 100%; min-height: 39px; padding: 0 11px; border: 1px solid rgba(255,255,255,.12); border-radius: 7px; background: #0b1219; color: #fff; font: inherit; }.check-control { display: flex; align-items: center; gap: 9px; color: #dfe4e9; font-size: 12px; cursor: pointer; }.check-control input { width: 18px; height: 18px; margin: 0; accent-color: #35a9f2; }.check-control--disabled { opacity: .52; cursor: not-allowed; }
