...
const searchResults = computed(() => splitPitwallConceptSearch(search.value));
...
/* Home refinement: one quiet search lane, compact actionable people, richer Crew identity. */
.pwc-home__main { min-width: 0; padding-top: 18px; }
.pwc-home__main > .pwc-search { width: min(100%, 720px); margin-top: 0; }
.pwc-driver-list,
.pwc-search-results { width: min(100%, 720px); }
.pwc-driver-list { gap: 18px; margin-top: 34px; }
.pwc-driver-card {
...
.pwc-driver-card::before { inset-block: 14px; }
.pwc-driver-card > strong { font-size: 17px; }
.pwc-driver-card .pwc-avatar { width: 46px; height: 46px; }
.pwc-search-results { margin-top: 22px; }
.pwc-person-row { grid-template-columns: 46px minmax(0, 1fr) auto; min-height: 72px; }

.pwc-crew-card { grid-template-columns: 82px minmax(0, 1fr) auto; }
.pwc-crew-image {
  width: 82px;
  height: 54px;
...
@media (max-width: 760px) {
  .pwc-home__main { padding-top: 4px; }
  .pwc-driver-list { margin-top: 24px; }
  .pwc-driver-card { grid-template-columns: 46px minmax(0, 1fr) auto; padding: 13px 14px; }
