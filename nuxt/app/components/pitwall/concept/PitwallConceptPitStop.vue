...
<template>
  <section class="pwc-panel">
    ...
    <PitwallConceptOrder
      :status="['acc-drive-7.8.1', 'mfd-v2', 'mfd-v3', 'mfd-v4'].includes(stop.application?.orderMethod.value ?? '') ? null : stop.orderStatus.value"
      :reason="['acc-drive-7.8.1', 'mfd-v2', 'mfd-v3', 'mfd-v4'].includes(stop.application?.orderMethod.value ?? '') ? null : stop.orderReason.value"
