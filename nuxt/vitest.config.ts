  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'app/services/overlay/sharedTelemetryLease.ts',
        ...
        'app/components/pitwall/PitwallTyreCondition.vue',
        ...
        // PIP-442: documento owner condiviso, cache persistente su disco e controllo di revisione.
        'app/repositories/ownerDocumentRepository.ts',
        'app/services/cache/ownerCachePayload.ts',
        'app/services/cache/ownerCacheSignals.ts',
        ...
        'app/services/sim/trackMapScene.ts',
        'app/services/sim/acc/accTrackMapScene.ts',
